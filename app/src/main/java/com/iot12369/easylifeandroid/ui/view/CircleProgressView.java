...
//    private int[] mColors;
    ...
    public CircleProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBorderWidth = a.getDimension(R.styleable.CircleProgressView_border_Width_circle,
                DEFAULT_BORDER_WIDTH * density);
        a.recycle();
//        mColors = new int[4];
//        mColors[0] = context.getResources().getColor(R.color.colorPrimary);
//        mColors[1] = context.getResources().getColor(R.color.colorPrimary);
//        mColors[2] = context.getResources().getColor(R.color.colorPrimary);
//        mColors[3] = context.getResources().getColor(R.color.colorPrimary);
